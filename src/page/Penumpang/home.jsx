...
// BAGIAN 1: KOMPONEN IMAGE GALLERY
const images = [
  ...
  return (
    <div>
      <div className="relative w-full overflow-hidden bg-gray-100 shadow-xl rounded-none">
        <div
          ref={galleryRef}
          className="flex transition-transform duration-500 snap-x snap-mandatory overflow-x-hidden h-91.75"
        >
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="bg-white py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            {/* Tab Menu with Background */}
            <div className="bg-gray-100 rounded-2xl p-6 mb-0">
              {/* Tabs */}
              <div className="flex gap-0 mb-6 w-fit">
                <button
                  onClick={() => setActiveTab("tickets")}
                  className={`flex items-center gap-2 px-6 py-3 font-medium rounded-l-lg transition-colors ${
                    activeTab === "tickets"
                ...
                >
                  <Ticket
                    size={20}
                    className={
                      activeTab === "tickets" ? "text-orange-500" : "text-white"
                    }
                  />
                  My Tickets
                </button>
                ...
                >
                  <Newspaper
                    size={20}
                    className={
                      activeTab === "news" ? "text-gray-800" : "text-white"
                    }
                  />
                  Latest News
                </button>
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 font-medium rounded-r-lg transition-colors ${
                    activeTab === "histories"
                      ? "bg-white text-gray-800 shadow-sm"
                      : "bg-gray-900 text-white"
                  }`}
                >
                  <Clock
                    size={20}
                    className={
                      activeTab === "histories" ? "text-gray-800" : "text-white"
                    }
                  />
                  Histories
                </button>
              ...
              <div className="flex gap-4">
                  ...
                  <div className="flex flex-col lg:flex-row relative">
                    ...
                    <div className="flex-1 p-6 lg:p-4">
                      ...
                      <div className="flex items-start justify-between mb-8">
                        ...
                        <span className="px-4 py-1.5 bg-white text-green-600 rounded-full text-sm font-semibold border-2 border-green-600">
                          Active
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="flex flex-col items-center px-6 lg:px-10">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <div className="w-24 lg:w-40 h-0.5 border-t-2 border-dashed border-gray-400"></div>
                            <div className="w-2.5 h-2.5 bg-orange-500 rounded-full"></div>
                          </div>
                      ...
                      {/* Bottom Info with Gray Background */}
                      <div className="flex flex-col lg:flex-row items-center lg:items-center gap-2 lg:gap-3 pt-4 pb-4 px-4 -mx-4 bg-gray-100 rounded-lg">
                    ...
                    <div className="absolute right-70 top-6 bottom-9 w-px border-l-2 border-dashed border-yellow-500 hidden lg:block z-10"></div>

                    {/* Right Section - Passenger Info */}
                    <div className="w-full lg:w-70 p-6 lg:p-8 bg-transparent">
                      <div className="mb-4 mt-14">
                        <div className="grid grid-cols-2 gap-x-4 gap-y-4 mb-4 text-left">
                          <div>
                          ...
                          <div>
                            ...
                            <div className="text-gray-900 font-semibold text-xs break-all">
                              ni.saraswati@binus.ac.id
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-around py-6 border-t border-gray-200">
                        <div className="text-center">
                          <div className="text-gray-500 text-xs mb-2">Bus</div>
                        ...
                        <div className="text-center">
                          <div className="text-gray-500 text-xs mb-2">Seat</div>
                          <div className="text-gray-900 font-bold text-5xl">
                            12
                          </div>
                        </div>
                ...
                {/* Barcode Section */}
                <div className="w-50 bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center justify-between">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-gray-900">BARCODE</h3>
                  </div>

                  <div className="bg-white p-2 rounded-lg mb-4">
                    <div className="w-32 h-32 bg-white border-2 border-gray-200 rounded">
                      <svg viewBox="0 0 100 100" className="w-full h-full">
                        ...
                        <rect x="55" y="40" width="4" height="4" fill="black" />
                        ...
                        <rect x="65" y="55" width="4" height="4" fill="black" />
                        <rect x="40" y="60" width="4" height="4" fill="black" />
                        <rect x="55" y="65" width="4" height="4" fill="black" />
                        <rect x="70" y="70" width="4" height="4" fill="black" />
                        <rect x="85" y="75" width="4" height="4" fill="black" />
                        <rect x="40" y="80" width="4" height="4" fill="black" />
                        <rect x="60" y="85" width="4" height="4" fill="black" />
                      </svg>
                    </div>
                  </div>
                  ...
                  <button className="text-[oklch(0.6155_0.1314_243.17)] text-xs font-medium hover:text-[oklch(0.55_0.14_243.17)] hover:underline">
                    View detail ticket...
                  </button>
                </div>
              </div>
        ...
        {/* What We Do Section - Fixed equal height cards */}
        <div className="bg-white py-16 px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Card 1 - Shuttle Booking */}
              <div className="h-full">
                <div className="bg-gray-100 rounded-xl p-6 h-full flex flex-col min-h-70">
                  <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shrink-0">
                    <Calendar className="w-7 h-7 text-[oklch(0.6155_0.1314_243.17)]" />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-center">Shuttle Booking</h3>
                  <p className="text-gray-600 text-md text-center flex-1">
              ...
              <div className="h-full">
                <div className="bg-gray-100 rounded-xl p-6 h-full flex flex-col min-h-70">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-center">Real-Time Tracking</h3>
                  <p className="text-gray-600 text-md text-center flex-1">
              ...
              <div className="h-full">
                <div className="bg-gray-100 rounded-xl p-6 h-full flex flex-col min-h-70">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-center">Schedule Management</h3>
                  <p className="text-gray-600 text-md text-center flex-1">
        ...
        {/* Testimonials Section - CAROUSEL WITH LINE INDICATORS */}
        <div className="bg-white py-16 px-8">
          <div className="max-w-6xl mx-auto">
